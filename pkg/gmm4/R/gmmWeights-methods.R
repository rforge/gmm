...
setMethod("quadra", c("gmmWeights", "matrixORnumeric", "missing"),
          function(w, x, y) {
              x <- as.matrix(x)
              if (is.character(w@w))
                  {
...
setMethod("quadra", c("gmmWeights", "matrixORnumeric", "matrixORnumeric"),
          function(w, x, y) {
              x <- as.matrix(x)
              y <- as.matrix(y)
              if (is.character(w@w))
...
setMethod("quadra", c("gmmWeights", "missing", "missing"),
          function(w, x, y) {
              if (is.character(w@w))
              {                  
                  obj <- "Identity"
...
setMethod("print", "gmmWeights",
          function(x, ...){
              cat("GMM weights matrix object\n")
              print(quadra(x), ...)})

setMethod("show", "gmmWeights", function(object) print(object))

### Subsetting method '['


setMethod("[", signature("gmmWeights","numeric","missing"),
          function(x, i, j)
              {
                  i <- as.integer(i)
                  if (is.character(x@w))
...
setMethod("[", signature("gmmWeights","missing","missing"),
          function(x, i,j)
              {
                  if (is.character(x@w))
                      return(x)
...
setMethod("quadra", c("sysGmmWeights", "matrixORnumeric", "missing"),
          function(w, x, y) {
              x <- as.matrix(x)
              if (is.character(w@w))
                  {
...
setMethod("quadra", c("sysGmmWeights", "matrixORnumeric", "matrixORnumeric"),
          function(w, x, y) {
              x <- as.matrix(x)
              y <- as.matrix(y)
              if (is.character(w@w))
...
setMethod("quadra", c("sysGmmWeights", "missing", "missing"),
          function(w, x, y) {
              if (is.character(w@w))
              {                  
                  obj <- "Identity"
...
setMethod("show", "sysGmmWeights", function(object) print(object))

### Subsetting method '['

setMethod("[", signature("sysGmmWeights","numeric", "missing"),
          function(x, i, j)
              {
                  i <- as.integer(i)
                  if (is.character(x@w))
...
setMethod("[", signature("sysGmmWeights","missing", "list"),
          function(x, i, j)
          {
              if (is.character(x@w))
                  return(x)
...
setMethod("[", signature("sysGmmWeights", "numeric", "list"),
